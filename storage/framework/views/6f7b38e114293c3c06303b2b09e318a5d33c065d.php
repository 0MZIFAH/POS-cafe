...
<body>
    ...
    <div class="self-container d-flex">
        ...
        <div class="col-3">
            <form action="<?php echo e(route('auth')); ?>" method="POST" class="d-flex flex-column px-4 justify-content-center">
                <?php echo csrf_field(); ?>
        ...
        <div class="col-9 bg-primary d-flex justify-content-center align-content-center">
            <img src="<?php echo e(asset('img/cashier.svg')); ?>" alt="">
        </div>
    </div>
...
</html><?php /**PATH /Users/admin/Desktop/Cafe-POS/Cafe-POS/resources/views/pages/auth/index.blade.php ENDPATH**/ ?>