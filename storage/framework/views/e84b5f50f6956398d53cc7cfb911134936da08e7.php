<?php $__env->startSection('title', 'Tambah Bahan-bahan'); ?>
<?php $__env->startSection('ingredients', 'active'); ?>

<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('includes.page-title', [
        'title' => 'Tambah Bahan',
        'paragraph' => 'Silahkan tambah bahan sesuai form yang
    disediakan',
    ...
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body pt-0">
                <form class="form form-vertical" action="<?php echo e(route('ingredients.store')); ?>" method="POST"
...
unset($__errorArgs, $__bag); ?>"></i>
                            ...
                            <div class="col-12">
                                <div class="form-group has-icon-left">
                                    <label for="first-name-icon">Kuantitas Bahan (Gr/Pcs)
...
unset($__errorArgs, $__bag); ?>" name="quantity"
                                            placeholder="Kuantitas Bahan" id="name" value="<?php echo e(old('quantity') ?? ''); ?>"
                                            autocomplete="off">
                                        <div class="form-control-icon">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cafe_db\resources\views/pages/admin/ingredient/create.blade.php ENDPATH**/ ?>