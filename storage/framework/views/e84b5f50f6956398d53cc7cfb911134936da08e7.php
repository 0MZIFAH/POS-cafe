...
<?php echo $__env->make('includes.page-title',['title' => 'Tambah Bahan','paragraph' => 'Silahkan tambah bahan sesuai form yang
...
unset($__errorArgs, $__bag); ?>"
                                        name="name" placeholder="Nama Bahan" id="name" value="<?php echo e(old('name') ?? ''); ?>"
                                        autocomplete="off">
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        value="<?php echo e(old('quantity') ?? ''); ?>" autocomplete="off">
                                    <div class="form-control-icon">
...
unset($__errorArgs, $__bag); ?>"
                                        name="price" placeholder="Harga" id="name" value="<?php echo e(old('price') ?? ''); ?>"
                                        autocomplete="off">
                                    <div class="form-control-icon">
