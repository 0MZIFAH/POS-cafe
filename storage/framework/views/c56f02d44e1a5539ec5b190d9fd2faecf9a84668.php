...
<body>
                ...
                <div class="col-lg-3">
                    <div class="card rounded-lg border-0 shadow-blue">
                        <div class="card-body pt-5 pb-5 d-flex flex-column align-items-center justify-content-center">
                            <img src="<?php echo e(Auth::user()->photo); ?>" width="100px" height="100px" style="object-fit: cover"
                                class="rounded-circle border-primary border-lg" />
                            <h5 class="pt-3 pb-4 text-primary"><?php echo e(Auth::user()->name); ?></h5>
                            <a href="<?php echo e(route('cashier.create')); ?>"
                                class="btn btn-block btn-primary shadow-blue mb-3 rounded-lg" target="__blank">Menu</a>
                            <form action="<?php echo e(route('auth.logout')); ?>" method="POST" id="logout">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div class="left">
                                        <div class="card-title pl-1">
                                            ...
                                            <h2 class="text-gray pt-3"><?php echo e($income); ?></h2>
                                        </div>
                                    </div>
                                    <div class="right">
                                        <img src="<?php echo e(asset('img/money.svg')); ?>" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body d-flex justify-content-between align-items-center">
                                    <div class="left">
                                        <div class="card-title pl-1">
                                            ...
                                            <h2 class="text-gray pt-3"><?php echo e($transaction_total); ?></h2>
                                        </div>
                                    </div>
                                    <div class="right">
                                        <img src="<?php echo e(asset('img/transaksi.svg')); ?>" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <form action="" method="GET">
                                            <div class="input-group">
                                                ...
                                                <button class="btn btn-success shadow-none">
                                                    <img src="<?php echo e(asset('img/search.svg')); ?>" alt="" />
                                                </button>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <div class="card border-0 rounded-lg shadow-blue mt-2">
                            <div class="card-body">
                                ...
                                <h6 class="text-gray text-center mt-2 transaction-table">
                                    <?php echo e($transaction->table_number); ?></h6>
                                <div class="wrapper-btn mt-4 d-flex justify-content-around">
                                    <button class="btn btn-sm rounded btn-success" data-toggle="modal"
                                        data-target="#modal-detail" data-transaction_id='<?php echo e($transaction->id); ?>'>
                                        <i data-feather="eye"></i>
                                    </button>
                                    <button class="btn btn-sm rounded btn-primary" data-toggle="modal"
                                        data-target="#modal-edit" data-transaction_id='<?php echo e($transaction->id); ?>'>
                                        <i data-feather="edit"></i>
                                    </button>
                                    <button class="btn btn-sm rounded btn-danger" data-toggle="modal"
                                        data-target="#modal-delete" data-transaction_id='<?php echo e($transaction->id); ?>'>
    ...
    <script>
        ...
        modalDetail.addEventListener('show.bs.modal',function(event){
            ...
            fetch('<?php echo e(route('cashier.index')); ?>/'+transaction_id)
            ...
            .then(result => {
                ...
                paid_btn.onclick = function(){
                    ...
                    fetch('<?php echo e(route("cashier.status")); ?>',{
                        headers: {
...
</html><?php /**PATH /Users/admin/Desktop/Cafe-POS/Cafe-POS/resources/views/pages/transaction/index.blade.php ENDPATH**/ ?>